...
## Project Structure
    ...
    ├── testapiautosettings_55203  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_55203`
...
2. Clone this repo and `cd testapiautosettings_55203`
